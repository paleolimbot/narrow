...
test_that("NULL to vctr works", {
  ...
  expect_identical(vctr$arrays[[1]]$length, as_arrow_offset(0))
  expect_identical(vctr$arrays[[1]]$null_count, as_arrow_offset(0))
...
test_that("NA to vctr works", {
  ...
  expect_identical(vctr$arrays[[1]]$length, as_arrow_offset(1))
  expect_identical(vctr$arrays[[1]]$null_count, as_arrow_offset(1))
...
test_that("small character(0) to vctr works", {
  ...
  vctr <- as_arrow_vctr(l)
  expect_identical(vctr$schema$format, "u")
  expect_identical(vctr$arrays[[1]]$length, as_arrow_offset(3))
  expect_identical(vctr$arrays[[1]]$null_count, as_arrow_offset(0))
...
test_that("large character(0) to vctr works", {
  ...
  vctr <- as_arrow_vctr(l)
  expect_identical(vctr$schema$format, "U")
  expect_identical(vctr$arrays[[1]]$length, as_arrow_offset(2 ^ 11))
  expect_identical(vctr$arrays[[1]]$null_count, as_arrow_offset(0))
