...
test_that("NULL to array works", {
  ...
  expect_identical(array$array_data$length, as_carrow_int64(0))
  expect_identical(array$array_data$null_count, as_carrow_int64(0))
...
test_that("NA to array works", {
  ...
  expect_identical(array$array_data$length, as_carrow_int64(1))
  expect_identical(array$array_data$null_count, as_carrow_int64(1))
  expect_identical(array$array_data$buffers[[1]], as_carrow_bitmask(FALSE))
  expect_identical(array$array_data$buffers[[2]], l)
})
...
test_that("small character(0) to array works", {
  ...
  array <- as_carrow_array(l)
  expect_identical(array$schema$format, "u")
  expect_identical(array$array_data$length, as_carrow_int64(3))
  expect_identical(array$array_data$null_count, as_carrow_int64(0))
...
test_that("large character() to array works", {
  ...
  array <- as_carrow_array(l)
  expect_identical(array$schema$format, "U")
  expect_identical(array$array_data$length, as_carrow_int64(2 ^ 11))
  expect_identical(array$array_data$null_count, as_carrow_int64(0))
...
test_that("factor() to array works", {
  ...
  expect_identical(array$array_data$length, as_carrow_int64(26 * 2 + 1))
  expect_identical(array$array_data$null_count, as_carrow_int64(1))
  expect_identical(array$array_data$buffers[[1]], as_carrow_bitmask(!is.na(l)))
