...
test_that("as_carrow_bitmask() works", {
  expect_identical(
  ...
  expect_identical(
    as_carrow_bitmask(c(FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE)),
  ...
  expect_identical(as_carrow_bitmask(logical()), new_arrow_bitmask())

  expect_identical(as_carrow_bitmask("TRUE"), as_carrow_bitmask(TRUE))
  b <- as_carrow_bitmask(TRUE)
  expect_identical(as_carrow_bitmask(b), b)
})
...
test_that("bitmask subset works", {
  ...
  expect_identical(new_arrow_bitmask(0xff)[1:2], as_carrow_bitmask(c(TRUE, TRUE)))
})
