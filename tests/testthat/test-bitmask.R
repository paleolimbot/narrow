...
test_that("as_sparrow_bitmask() works", {
  expect_identical(
  ...
  expect_identical(
    as_sparrow_bitmask(c(FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE)),
  ...
  expect_identical(as_sparrow_bitmask(logical()), new_arrow_bitmask())

  expect_identical(as_sparrow_bitmask("TRUE"), as_sparrow_bitmask(TRUE))
  b <- as_sparrow_bitmask(TRUE)
  expect_identical(as_sparrow_bitmask(b), b)
})
...
test_that("bitmask print method works", {
  ...
  expect_output(print(new_arrow_bitmask()), "sparrow_arrow_bitmask")
})
...
test_that("bitmask subset works", {
  ...
  expect_identical(new_arrow_bitmask(0xff)[1:2], as_sparrow_bitmask(c(TRUE, TRUE)))
})
